...
import com.aafa.test.inditex.infrastructure.database.adapter.BrandRepositoryH2Adapter;
...
public class BrandRepositoryH2AdapterTest {
    ...
    @Test
    public void findAllReturnsListOfBrandsWhenBrandsExist() {
    ...
    @Test
    public void findByIdReturnsBrandWhenBrandExists() {
        Long brandId = 1L;
